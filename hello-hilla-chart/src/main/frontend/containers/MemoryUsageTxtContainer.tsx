...
import MemoryUsageTxt from "Frontend/components/MemoryUsageTxt";

const MemoryUsageTxtContainer: React.FC = () => {
	...
	return <MemoryUsageTxt memoryData={memoryData.value} />;
};

export default MemoryUsageTxtContainer;
